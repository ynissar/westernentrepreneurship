  ...
  return (
    <section>
      <motion.div
        ...
        animate={animation}
        initial={{ opacity: 0 }}
        className=" py-12 px-16 md:px-28 lg:px-52 mt-16 flex flex-col items-center 2xl:flex-row justify-between"
      >
        <div className="mt-24 mb-10 min-w-xl max-w-2xl sm:mr-12">
          <p className="font-bold text-4xl text-theme text-center md:text-left">
            What is W5?
          </p>
          <p className="font-semibold text-lg mt-1 text-center md:text-left">
